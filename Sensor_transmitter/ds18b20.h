...
#define DISABLE_SENSOR_POWER()	P2DIR&=~BIT3; P2OUT&=~BIT3; setOneWireDir(LOW);
...
/* ------------------------------------------------------------------------- */
#define system_clock 8 //in MHz
#define us_to_ncyles(a)  a*system_clock
